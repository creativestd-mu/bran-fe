...
export const NAV_SEARCH_INDEX: NavSearchItem[] = [
  ...
  },
  {
    label: "Connectors",
    path: "/connectors",
    description: "Connect Google Meet / Calendar and Gmail",
    icon: Plug,
    weight: 9,
    keywords: [
      "connectors", "meetings", "google meet", "meet", "calendar", "notetaker",
  ...
  },
  {
    label: "Events",
    path: "/events",
    description: "Org events timeline from mail, meetings, and other sources",
    icon: CalendarClock,
    weight: 9,
    keywords: [
      "events", "timeline", "activity", "launch", "campaign", "workshop",
      "org events", "detect", "cluster", "manual event", "auto event",
    ],
  },
  {
    label: "Brain map",
  ...
  },
  {
    label: "Preread",
    path: "/preread",
    description: "Tree-shaped prereads with shared access, node comments, and media",
    icon: BookOpen,
    weight: 9,
    keywords: [
      "preread", "pre-read", "tree", "blocker", "advice", "output",
      "share", "collaboration", "discussion", "node", "comments",
    ],
  },
  {
    label: "Content",
